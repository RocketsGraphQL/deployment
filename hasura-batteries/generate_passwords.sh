...
sed -i '.bak' "s$dir/kaushik_replace_postgrespassword/$postgres_password/g" docker-compose.yml
...
sed -i '.bak' "s$dir/kaushik_replace_myadminsecret/$hasura_secret/g" docker-compose.yml
